...
def upgrade():
    ...
    op.create_table('stock_item_state',
    sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('date_created', postgresql.TIMESTAMP(timezone=True), nullable=True),
    sa.Column('date_updated', postgresql.TIMESTAMP(timezone=True), nullable=True),
    ...
    op.create_table('snapshot_stock_item_state',
    sa.Column('snapshot_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.Column('stock_item_state_id', postgresql.UUID(as_uuid=True), nullable=False),
    sa.ForeignKeyConstraint(['snapshot_id'], ['snapshot.id'], ),
    sa.ForeignKeyConstraint(['stock_item_state_id'], ['stock_item_state.id'], ),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('snapshot_stock_item_state')
    op.drop_table('stock_item_state')
